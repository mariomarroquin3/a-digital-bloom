...
const MemorySlider = () => {
  ...
  return (
    <section ref={containerRef} className="relative z-20 py-32 md:py-40 overflow-hidden">
      <ScrollReveal>
            ...
            return (
              ...
              >
                <motion.div
                  ...
                  style={{ y: backgroundY }}
                >
                  {/* Placeholder gradient background with parallax */}
                  <motion.div
                    className="absolute inset-0 bg-gradient-to-br from-primary/30 via-accent/40 to-secondary"
                    style={{
